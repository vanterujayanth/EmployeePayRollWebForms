<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDetails.aspx.cs" Inherits="Pay_Roll_Form.Pages.UpdateDetails" %>
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style16" colspan="2">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox4" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationExpression="[0-9]{1,}">*Salary should be like this &quot;12345&quot;.</asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                       <%-- <td class="auto-style3">
                        ...
                        <td class="auto-style4">
                            <asp:Button ID="Button4" runat="server" OnClick="Button_Update" Text="Submit" Width="105px" BackColor="#2835D2" BorderColor="#2835D2" BorderStyle="Double" BorderWidth="0px" CssClass="auto-style24" Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="50px" />
                        </td>
                    </tr>
                </table>
            </form>
